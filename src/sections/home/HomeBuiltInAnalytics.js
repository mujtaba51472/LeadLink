        ...
        <ScreenStyle>
          <Grid container>
            <Grid item xs={12} md={6} display="flex" justifyContent="center" alignItems="center" order="2">
              <img src="https://66biolinks.com/demo/themes/altum/assets/images/index/analytics.png" alt="biolink" />
            </Grid>
            <Grid item xs={10} md={6} display="flex" justifyContent="center" alignItems="center" paddingRight="30px">
              ...
              <Stack direction="column" gap="14px">
                ...
                <Typography variant="h3">Built-in analytics</Typography>
